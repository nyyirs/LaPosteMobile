...
class OperatorDatabaseOperations:
    ...
    def insert_into_forfaits(self, OperateurID, limite, unite, compatible5g=0, adsl=0, fibre=0, avecEngagement=0, annee=0, dejaClient=0):
        query = """
        INSERT INTO Forfaits (OperateurID, Donnees, UniteDonnees, Compatible5G, Adsl, Fibre, AvecEngagement, Annee, DejaClient)
        VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s); SELECT SCOPE_IDENTITY();
        """
        return self.db_util.insert_and_return_id(query, (OperateurID, limite, unite, compatible5g, adsl, fibre, avecEngagement, annee, dejaClient))
